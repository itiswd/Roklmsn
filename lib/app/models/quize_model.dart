...
class AnswerSheet {
  ...
  Map<String, dynamic> toJson() {
    ...
    for (var item in items.entries) {
      data.addAll({item.key: item.value?.toJson()});
    }
...
class Question {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['created_at'] = createdat;
    data['answers'] =
    answers != null ? answers!.map((v) => v?.toJson()).toList() : null;
    data['updated_at'] = updatedat;
    data['image'] = image;
    return data;
  }
...
class QuizReview {
  ...
  QuizReview.fromJson(Map<String, dynamic> json) {
    ...
    multiplecorrectanswer = json['multiple_correct_answer'] != null
        ? MultipleCorrectAnswer?.fromJson(json['multiple_correct_answer'])
        : null;
  }
