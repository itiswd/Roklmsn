...
class SingleCourseWidget{
  ...
  static Widget informationPage(SingleCourseModel courseData, bool viewMore, Function onTapViewMore,Function changeState,{List<CourseModel> bundleCourses = const [], required BuildContext context}){
          ...
          Container(
            ...
            child: Wrap(
              ...
              children: [
                ...
                //   width: (getSize().width * .5) - 42, context: context,
                // ),
                        ...
                        children: List.generate(contents[index].items?.length ?? 0, (i) {
                          return horizontalChapterItem(
                            ...
                            subTitleType(contents[index].items![i]),
                                (){
                              print("contents[index].items?[i].can?.view ?? false");
                              print(contents[index].items?[i].can?.view ?? false);
  ...
  static Widget reviewsPage(SingleCourseModel courseData, {required BuildContext context}){
  ...
  static Widget commentsPage(SingleCourseModel courseData, {required BuildContext context}){
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              userProfile(review.user!,showRate: true, customRate: review.rate, context: context),
  ...
  static Widget courseStatus(String title,String desc,String iconPath, {double? width, required BuildContext context}){
    return SizedBox(
