...
class _QuizPageState extends State<QuizPage> {
  ...
  getData() async {
    ...
    if(res != null){
      ...
      //
      print("Before quizData!.questions?[0].image");
      print(quizData!.questions?[0].image);
      print("quizData!.questions?[0].image");
      //
      // print(res);
      // print(all);
  ...
  Widget build(BuildContext context) {
    ...
    return directionality(
        child: Scaffold(
            appBar: AppBar(
              backgroundColor: Theme.of(context).appBarTheme.backgroundColor ?? Theme.of(context).primaryColor, // Use theme color for background
              elevation: 0,
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: Theme.of(context).iconTheme.color?.withOpacity(0.2) ?? Colors.black.withOpacity(0.2), // Icon button color from theme
                      ...
                      Text(
                        quizData?.title ?? '',
                        style: style16Regular().copyWith(color: Theme.of(context).textTheme.bodyMedium?.color ?? Colors.white.withOpacity(.1)), // Text color from theme
                      ),
                    ],
                  ),
                ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (quizData!.questions![currentQuestionIndex].image != '')
                                Center(
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(10), // تعديل البوردر
                                    child: Image.network(
                                      quizData?.questions?[currentQuestionIndex].image?? '',
                                      // "https://mrdoctor.anmka.com${quizData?.questions?[currentQuestionIndex].image}" ?? '',
                                      fit: BoxFit.cover,
                                      height: 250,
                                      // errorBuilder: (context, error, stackTrace) => Text("ERROR",style: TextStyle(color: Colors.red),), // إخفاء الصورة في حالة الخطأ
                                    ),
                                  ),
                                ),
                                          ...
                                          children: [
                                            ...
                                            GestureDetector(
                                              ...
                                              child: Container(
                                                ...
                                                decoration: BoxDecoration(
                                                    color: Colors.white.withOpacity(.1).withOpacity(.1),
                      ...
                      children: [
                        ...
                        Expanded(
                            child: button(
                                ...
                                bgColor: Colors.white.withOpacity(.1),
