...
class _UserProfilePageState extends State<UserProfilePage> with TickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    return directionality(
      child: Scaffold(
        appBar: appbar(title: profile?.fullName ?? '', context: context),
              ...
              child: NestedScrollView(
                    ...
                    SliverAppBar(
                      ...
                      title: SizedBox(
                        ...
                        child: tabBar(
                          ...
                          horizontalPadding: 24, context: context
                        )
                      ),
                    ),
                ...
                body: TabBarView(
                  ...
                  children: [
                    ...
                    UserProfileWidget.classesPage(profile ?? ProfileModel(), context: context),
