              ...
              children: [
                ...
                Directionality(
                  ...
                  child: Row(
                    ...
                    children: [
                      RegisterWidget.codeInput(controller1, codeNode1,
                          codeNode2, null, onPastedCode),
                      space(0, width: 10),
                      RegisterWidget.codeInput(controller2, codeNode2,
                          codeNode3, codeNode1, onPastedCode),
                      space(0, width: 10),
                      RegisterWidget.codeInput(controller3, codeNode3,
                          codeNode4, codeNode2, onPastedCode),
                      space(0, width: 10),
                      RegisterWidget.codeInput(controller4, codeNode4,
                          codeNode5, codeNode3, onPastedCode),
                      space(0, width: 10),
                      RegisterWidget.codeInput(controller5, codeNode5, null,
                          codeNode4, onPastedCode),
                    ],
                  ),
                ),
                        ...
                        if (!isEmptyInputs) {
                          ...
                          if (code.length == 5) {
                            ...
                            if (res) {
                              ...
                              bool step3 =
                                  await AuthenticationService.registerStep3(
                                data['user_id'],
                                data["fullName"],
                                "",
                              );
                ...
                Center(
                  child: isCodeAgain
                      ...
                      : GestureDetector(
                          onTap: () async {
                            if (PublicData.apiConfigData['register_method'] ==
                                'email') {
                              setState(() {
                                isCodeAgain = true;
                              });
