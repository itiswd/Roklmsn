          ...
          body: GestureDetector(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: padding(),
                  child: closeButton(AppAssets.arrowClearSvg, context: context),
                ),
...
Widget closeButton(String icon,{Function onTap=backRoute,double? width, Color? icColor, required BuildContext context}){
