...
abstract class AppLocalizations {
  ...
  /// No description provided for @done_download.
  ///
  /// In en, this message translates to:
  /// **'Uploaded files'**
  String get done_download;
  ...
  /// No description provided for @phoneNumberNote.
  ///
  /// In en, this message translates to:
  /// **'It must have WhatsApp.'**
  String get phoneNumberNote;

  /// No description provided for @nameNote.
  ///
  /// In en, this message translates to:
  /// **'The name must be four parts.'**
  String get nameNote;

  /// No description provided for @requestEnrollment.
  ///
  /// In en, this message translates to:
  /// **'Request Enrollment on Course'**
  String get requestEnrollment;

  /// No description provided for @enrollmentPage.
  ///
  /// In en, this message translates to:
  /// **'EnrollmentPage'**
  String get enrollmentPage;

  /// No description provided for @firstNumberContactUs.
  ///
  /// In en, this message translates to:
  /// **'01013125131'**
  String get firstNumberContactUs;

  /// No description provided for @developedBy.
  ///
  /// In en, this message translates to:
  /// **'Developed By - Khaled Wael'**
  ...
  /// No description provided for @featuredStudent.
  ///
  /// In en, this message translates to:
  /// **'Featured Student'**
  String get featuredStudent;

  /// No description provided for @welcomeAhmed.
  ///
  /// In en, this message translates to:
  /// **'Welcome, Ahmed!'**
  String get welcomeAhmed;
  ...
  /// No description provided for @whatSubjectToStudy.
  ///
  /// In en, this message translates to:
  /// **'What subject do you want to study?'**
  String get whatSubjectToStudy;
  ...
  /// No description provided for @chapter_code.
  ///
  /// In en, this message translates to:
  /// **'Chapter Code'**
  String get chapter_code;
